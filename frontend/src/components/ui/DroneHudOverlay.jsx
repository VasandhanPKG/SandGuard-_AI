...
export default function DroneHudOverlay() {
  ...
  return (
    <div className="relative w-full h-[480px] bg-[#050b18] rounded-xl overflow-hidden border border-[#00e5ff]/40 shadow-2xl select-none font-mono">
      {/* Top HUD Status Bar */}
      <div className="absolute top-4 left-4 right-4 z-20 flex items-center justify-between bg-[#0f172a]/90 backdrop-blur-md border border-[#00e5ff]/30 px-4 py-2 rounded-lg text-xs text-[#00e5ff]">
        ...
        <div className="flex items-center space-x-4">
          <button
            ...
            className={`px-3 py-1 rounded text-xs font-bold transition-all border ${
              thermalMode ? 'bg-[#00e5ff]/20 text-[#00e5ff] border-[#00e5ff]' : 'bg-gray-800 text-gray-400 border-gray-700'
            }`}
          >
      ...
      <svg className="w-full h-full" viewBox="0 0 800 480">
        ...
        <line x1="400" y1="40" x2="400" y2="440" stroke="rgba(0, 229, 255, 0.25)" strokeWidth="1" strokeDasharray="6,6" />
        <line x1="40" y1="240" x2="760" y2="240" stroke="rgba(0, 229, 255, 0.25)" strokeWidth="1" strokeDasharray="6,6" />

        {/* Central HUD Target Pitch / Roll Rings */}
        <circle cx="400" cy="240" r="80" fill="none" stroke="rgba(0, 229, 255, 0.3)" strokeWidth="1.5" />
        <circle cx="400" cy="240" r="160" fill="none" stroke="rgba(0, 229, 255, 0.15)" strokeWidth="1" />
        <circle cx="400" cy="240" r="4" fill="#00e5ff" />

        {/* AI Object Detection Bounding Boxes */}
        {/* 1. EXCAVATOR (Critical Red Box) */}
        <g transform="translate(240, 180)">
          <rect width="130" height="90" fill="rgba(239, 68, 68, 0.2)" stroke="#ef4444" strokeWidth="2.5" className="animate-pulse" />
        ...
        <g transform="translate(480, 220)">
          <rect width="140" height="75" fill="rgba(245, 158, 11, 0.2)" stroke="#f59e0b" strokeWidth="2" />
        ...
        <g transform="translate(140, 320)">
          <rect width="160" height="80" fill="rgba(239, 68, 68, 0.25)" stroke="#ef4444" strokeWidth="2" />
      ...
      <div className="absolute bottom-4 left-4 right-4 z-20 flex items-center justify-between bg-[#0f172a]/90 backdrop-blur-md border border-[#00e5ff]/30 px-4 py-2 rounded-lg text-xs text-gray-300">
        <div>TARGET GPS: <strong className="text-emerald-400">11.3412° N, 77.7172° E</strong> (Bhavani River Sector 4B)</div>
        <div>PAYLOAD: <strong className="text-[#00e5ff]">OPTICAL 4K + FLIR IR DUAL SENSOR</strong></div>
      </div>
    </div>
  );
}
